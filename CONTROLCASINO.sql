/* Datos para crear la tabla en SqlOracle */

/* Script para crear el Usuario */
Alter session set "_oracle_script"=true;
CREATE USER CONTROLCASINO IDENTIFIED BY "CONTROLCASINO"
DEFAULT TABLESPACE SYSTEM
TEMPORARY TABLESPACE TEMP
QUOTA UNLIMITED ON DATA;
GRANT "CONNECT" TO "CONTROLCASINO";
GRANT "RESOURCE" TO "CONTROLCASINO";
